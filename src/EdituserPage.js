                        ...
                        <div className="main-register-area">
                            ...
                            <div className="register-view">
                                <div className="texts">
                                    ...
                                    <h1>Enter you're new information</h1>
                                    <p>This information will change permanently, be cautious.</p>
                                </div>
                                <form onSubmit={this.onSubmit}>
                                    <div className="input-group">
                                        <label htmlFor="username">Username</label>
                                        <input type="text" name="username" id="username" placeholder="Enter username" value={this.props.username} onChange={this.handleChange} />
                                    </div>
                                    <div className="input-group">
                                        <label htmlFor="email">Email</label>
                                        <input type="email" name="email" id="email" placeholder="Enter email" value={this.props.email} onChange={this.handleChange} />
                                    </div>
                                    <div className="input-group">
